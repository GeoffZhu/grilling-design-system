...
- Library: pass --language to library.py. For non-English sessions, pass --ui-copy with a flat translation of assets/library-copy.json keys on every generation, including delivery. The generator preserves App.tsx, so inspect and translate it when resuming.
...
- DESIGN.md: rewrite generated explanations in the user's language before delivery. Preserve commands, file paths, confirmed facts, and verification limits. Recheck after regeneration.
