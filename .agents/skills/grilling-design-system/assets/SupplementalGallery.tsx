...
export default function SupplementalGallery(){return <>
  ...
  <section className="gallery-item" id="attachment-demo"><h3>attachment</h3><Attachment><AttachmentMedia><FileText/></AttachmentMedia><AttachmentContent><AttachmentTitle>{text['Design reference.pdf']}</AttachmentTitle><AttachmentDescription>{text['2.4 MB · Ready']}</AttachmentDescription></AttachmentContent></Attachment></section>
  <section className="gallery-item" id="bubble-demo"><h3>bubble</h3><div className="space-y-3"><Bubble><BubbleContent>{text['A small step forward.']}</BubbleContent></Bubble><Bubble align="end" variant="secondary"><BubbleContent>{text["Let's make it happen."]}</BubbleContent></Bubble></div></section>
  <section className="gallery-item" id="marker-demo"><h3>marker</h3><Marker><MarkerIcon><Check/></MarkerIcon><MarkerContent>{text['Completed']}</MarkerContent></Marker></section>
  <section className="gallery-item" id="message-demo"><h3>message</h3><Message><MessageContent><MessageHeader>{text['Alex · 9:41']}</MessageHeader><Bubble><BubbleContent>{text['Everything is ready for review.']}</BubbleContent></Bubble><MessageFooter>{text['Delivered']}</MessageFooter></MessageContent></Message></section>
